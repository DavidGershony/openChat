...
{
    /// <summary>
    /// Global flag set once at app startup by the platform head.
    /// Used by shared UI controls (e.g. MessageBubble) that don't have access to a
    /// PlatformContext instance through the ViewModel chain.
    /// </summary>
    public static bool IsMobileGlobal { get; set; }
