...
public class NotificationOrchestrator : IDisposable
{
    ...
    private async void OnNewMessage(Scramble.Core.Models.Message message)
    {
        try
        {
            ...
            {
                Scramble.Core.Models.MessageType.Image => "Sent an image",
                Scramble.Core.Models.MessageType.Audio => "Sent a voice message",
                Scramble.Core.Models.MessageType.File => "Sent a file",
