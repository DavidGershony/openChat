...
[Activity(Label = "Scramble", Theme = "@style/AppTheme", Exported = true,
...
public class ShareTargetActivity : AppCompatActivity
{
    ...
    protected override void OnCreate(Bundle? savedInstanceState)
    {
        ...
        toolbar.Title = "Share to Scramble";
    ...
    private void LoadAccounts()
    {
        ...
        if (_accounts.Count == 0)
        {
            ...
            Toast.MakeText(this, "No accounts found. Open Scramble first.", ToastLength.Short)?.Show();
            Finish();
            return;
        }
