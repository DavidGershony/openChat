...
public class SecurityAuditTests
{
    ...
    public void AndroidManifest_HasBackupDisabled()
    {
        ...
        while (dir != null)
        {
            var candidate = Path.Combine(dir, "src", "Scramble.Android", "Properties", "AndroidManifest.xml");
    ...
    public void LoggingConfiguration_DefaultsToInformation()
    {
        ...
        var method = typeof(Scramble.Core.Logging.LoggingConfiguration).GetMethod("Initialize");
