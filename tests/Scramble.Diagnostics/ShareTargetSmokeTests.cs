...
public class ShareTargetSmokeTests
{
    ...
    public void ShareSheet_ShowsScramble_WhenSharingText()
    {
        // Steps:
        // 1. Open Chrome, navigate to any page
        // 2. Long-press a URL or tap Share
        // 3. Verify Scramble appears in the share sheet
        // 4. Tap Scramble → ShareTargetActivity opens
    }

    [Fact(Skip = "Manual device test — share image from gallery")]
    public void ShareSheet_ShowsScramble_WhenSharingImage()
    {
        // Steps:
        // 1. Open Photos/Gallery app
        // 2. Select an image, tap Share
        // 3. Verify Scramble appears in the share sheet
        // 4. Tap Scramble → ShareTargetActivity opens with image preview
    }

    [Fact(Skip = "Manual device test — multi-account picker")]
    public void ShareTarget_ShowsAccountPicker_WhenMultipleAccounts()
    {
        // Precondition: 2+ accounts registered in Scramble
        // Steps:
        // 1. Share any content into Scramble
    ...
    {
        // Steps:
        // 1. Share text from another app into Scramble
    ...
    {
        // Steps:
        // 1. Force-stop Scramble from Settings
